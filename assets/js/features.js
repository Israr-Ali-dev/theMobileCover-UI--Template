!(function () {
  ...
  var Ot = t(function (t, n) {
      ...
      var e = {
        track: function r() {
          var t;
          'undefined' != typeof themobilecaseAnalytics &&
            themobilecaseAnalytics.lib &&
            (t = themobilecaseAnalytics.lib).track.apply(t, arguments);
        },
      };
      n['default'] = e;
    }),
    Tt = t(function (t, n) {
      ...
      function r(t, n) {
        var e = 'themobilecase-features__' + n,
          r = e + '--disabled',
          o = e + '--enabled',
      ...
      function o() {
        var t = 'themobilecase-dynamic-checkout';
      ...
      var i =
        '\n.themobilecase-payment-button__button--hidden {\n  visibility: hidden;\n}\n\n.themobilecase-payment-button__button {\n  border-radius: 4px;\n  border: none;\n  box-shadow: 0 0 0 0 transparent;\n  color: white;\n  cursor: pointer;\n  display: block;\n  font-size: 1em;\n  font-weight: 500;\n  line-height: 1;\n  text-align: center;\n  width: 100%;\n  transition: background 0.2s ease-in-out;\n}\n\n.themobilecase-payment-button__button[disabled] {\n  opacity: 0.6;\n  cursor: default;\n}\n\n.themobilecase-payment-button__button--unbranded {\n  background-color: #1990c6;\n  padding: 1em 2em;\n}\n\n.themobilecase-payment-button__button--unbranded:hover:not([disabled]) {\n  background-color: #136f99;\n}\n\n.themobilecase-payment-button__more-options {\n  background: transparent;\n  border: 0 none;\n  cursor: pointer;\n  display: block;\n  font-size: 1em;\n  margin-top: 1em;\n  text-align: center;\n  width: 100%;\n}\n\n.themobilecase-payment-button__more-options:hover:not([disabled]) {\n  text-decoration: underline;\n}\n\n.themobilecase-payment-button__more-options[disabled] {\n  opacity: 0.6;\n  cursor: default;\n}\n\n.themobilecase-payment-button__button--branded {\n  display: flex;\n  flex-direction: column;\n  min-height: 44px;\n  position: relative;\n  z-index: 1;\n}\n\n.themobilecase-payment-button__button--branded .themobilecase-cleanslate {\n  flex: 1 !important;\n  display: flex !important;\n  flex-direction: column !important;\n}\n';
    }),
    jt = t(function (t, n) {
      'use strict';
      function e(n, e) {
      ...
      function r() {
        function r() {
          return document.querySelector('[data-themobilecase=payment-button]');
        }
        return new Promise(function (e) {
          r()
            ? e(!0)
            : window.themobilecase.designMode
      ...
      function i(t, n) {
        ...
        return (
          ...
          (r.dataset.sourceAttribute =
            'themobilecase.dynamic_checkout.product.init'),
          e.head.appendChild(r),
          r
        );
      }
      function u(n, e) {
        'undefined' == typeof window.themobilecase.PaymentButton &&
          (window.themobilecase.PaymentButton = {
            init: function r() {
              var t = o(n, e);
              (t.onload = function () {
                s();
                ...
                (window.themobilecase.PaymentButton.init = function () {});
            },
          });
      }
      function c(t) {
      ...
      function s() {
        var t = 'polyfilled_dynamic_checkout',
          n =
            window.themobilecase &&
            window.themobilecase.theme &&
            window.themobilecase.theme.name,
    ...
    Ft = t(function (t, n) {
      ...
      function r() {
        ...
        return new Promise(function (e) {
          r()
            ? ((window.themobilecase.CartType = 'cart_page'), e())
            : new MutationObserver(function (t, n) {
                r() &&
                  ((window.themobilecase.CartType = 'cart_ajax'),
                  e(),
                  n.disconnect());
              }).observe(document.body, { childList: !0, subtree: !0 });
        });
      ...
      function o(t, n) {
        ...
        return (
          ...
          (r.dataset.sourceAttribute =
            'themobilecase.dynamic_checkout.cart.init'),
          e.head.appendChild(r),
          r
        );
      }
