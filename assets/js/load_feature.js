!(function () {
  var e = function (e) {
    ...
    v = e(function (e, t) {
      ...
      function r() {
        if (a) return a;
        var e = document.getElementById('themobilecase-features');
        if (e)
          try {
    ...
    d = e(function (e, t) {
      ...
      function r(e) {
        ...
        return (
          ...
          u && (d = d + '.' + u),
          'https://' +
            ((window.themobilecase && window.themobilecase.cdnHost) ||
              'cdn.themobilecase.com') +
            '/themobilecasecloud/' +
            l +
            '/v' +
            r +
    ...
    _ = e(function (e, t) {
      'use strict';
      function r(e, t) {
        var r = window.themobilecase[e] && window.themobilecase[e].q;
        r &&
          Array.isArray(r) &&
          r.forEach(function (e) {
            t.apply(undefined, n(e));
          }),
          (window.themobilecase[e] = t);
      }
      Object.defineProperty(t, '__esModule', { value: !0 }), (t['default'] = r);
    });
  e(function (e, t) {
    ...
    (t.register = p.register),
      ...
      (0, p.register)({
        ...
        version: '0.6',
        hasLegacy: !0,
        autoLoadSelector: 'model-viewer[data-themobilecase-feature="0.6"]',
      }),
      (0, p.register)({
        name: 'model-viewer',
        version: '0.7',
        hasLegacy: !0,
        autoLoadSelector: 'model-viewer[data-themobilecase-feature="0.7"]',
      }),
      (0, p.register)({
        name: 'model-viewer',
        version: '0.8',
        hasLegacy: !0,
        autoLoadSelector: 'model-viewer[data-themobilecase-feature="0.8"]',
      }),
      (0, p.register)({
        name: 'model-viewer',
        version: '1.2',
        hasLegacy: !0,
        autoLoadSelector: 'model-viewer[data-themobilecase-feature="1.2"]',
      }),
      (0, p.register)({
        ...
        hasLegacy: !1,
        localized: !1,
        autoLoadSelector: 'themobilecase-payment-terms',
      }),
      (0, p.register)({
      ...
      (0, p.register)({
        name: 'themobilecase-xr',
        version: '1.0',
        baseName: 'themobilecase-xr-js',
        fileName: 'themobilecase-xr',
        localized: !0,
      }),
      (0, p.register)({
        name: 'video-ui',
        baseName: 'themobilecase-plyr',
        version: '1.0',
        hasLegacy: !0,
        localized: !0,
      }),
