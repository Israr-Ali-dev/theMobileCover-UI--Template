    ...
    <div class="page-narrow page-content">
        <div class="grid">
            <div class="grid__item">
                ...
                <form action="/cart" method="post" novalidate class="cart cart-page-form">

                    <div class="cart__item cart__item--headers small--hide">
                        <div class="cart__item--details">
                            <div class="cart__item--qty">Quantity</div>
                            <div class="cart__item--price text-right">Total</div>
                        </div>
                    </div>
                    <div class="cart__item">
                        <div class="cart__item--image" data-aos>
                            <a href="#" class="image-wrap"
                                style="display: block; height: 0; padding-bottom: 133.333333333%;">
                                <img src="assets/img/c1.png" class="cart-img"
                        ...
                        <div class="cart__item--details">
                            ...
                            <div class="cart__item--qty">
                                ...
                                <div class="js-qty__wrapper">
                                    <input type="text" id="cart_update" class="js-qty__num" value="12"
                                        data-id="33193848012853:91f002e60bc565069bbe1295e6719727" min="0"
                                        pattern="[0-9]*" name="update">
                            ...
                            <div class="cart__item--price text-right"><span class="cart__price">
                                    <div class="pn-total-line-item"
                                        data-id="33193848012853:91f002e60bc565069bbe1295e6719727">$444.00</div>
                                </span></div>
                        </div>
                    </div>
                    <div class="cart__footer">
                        <div class="grid">
                            <div
                                class="grid__item medium-up--one-half text-center medium-up--text-right medium-up--push-one-half">
                                ...
                                <p class="ajaxcart__note ajaxcart__note--terms">
                                    ...
                                    <label for="CartPageAgree">I confirm I have selected the correct phone model.
                                    </label>
                                </p>
                                <div class="cart__checkout-wrapper">
                                    <button type="submit" name="update"
                                        class="btn btn--no-animate cart__update visually-hidden">
                                        Update cart
                                    </button>
                                    <button type="submit" name="checkout"
                                        class="btn btn--no-animate cart__checkout cart__checkout--page">
                                        Check out
                                    </button>
                                            ...
                                            <div>
                                                            ...
                                                            <defs>
                                                                ...
                                                                <symbol id="shopify-svg__error" viewBox="0 0 18 18">
                                                                    ...
                                                                    <rect x="7.8" y="12" width="2.5" height="2.5"
                                                                        rx="1.3" style="fill: rgb(255, 255, 255);">
                                                                    </rect>
                                                                </symbol>
                                                                ...
                                                                <symbol id="shopify-svg__payments-shopify-pay-dark"
                                                                    ...
                                                                    <rect x="383.23" y="214.02" width="141.73"
                                                                        height="90.42" rx="14.17" style="fill: white;">
                                                                    </rect>
                                                                    <path
                                                                ...
                                                                <symbol id="shopify-svg__payments-shopify-pay-light"
                                                                    viewBox="134 256 410 1">
                                                                    <path
                                                                        d="M241.22,242.74c-3.07-6.44-8.89-10.6-17.66-10.6a17.58,17.58,0,0,0-13.81,7.1l-.32.39V214.39a.55.55,0,0,0-.55-.55h-12.4a.55.55,0,0,0-.54.55v72.4a.54.54,0,0,0,.54.54h13.28a.55.55,0,0,0,.55-.54V255.92c0-6,4-10.25,10.4-10.25,7,0,8.77,5.76,8.77,11.63v29.49a.54.54,0,0,0,.54.54h13.25a.55.55,0,0,0,.55-.54V255.54c0-1.07,0-2.12-.14-3.14A27.63,27.63,0,0,0,241.22,242.74Z"
                                                                        style="fill: white;"></path>
                                                ...
                                                <div class="shopify-cleanslate">
                                                    <div class="_38ksdFFHosgt4hh6EjDuLm _3mgStMpRn3ZERlUsxma1Bc">
                                                        <div class="_1mqqPYZtCQtz5_i0b-po4l"
                                                            data-shopify-buttoncontainer="true">
                                                            <div class="_3TUeZPsTWjDxakSmeDcA4D"
                                                                data-testid="grid-cell">
                                                                <div role="button" tabindex="0"
                                                                    class="_1LP9NPTft85QosIXd3_zOV _3G6VJhJYno-AX3-X38f1TA _2zarRkvJ2j83NID3Q3t0Ix _3xia0N5Q9Mk6-VTLoOX95a"
                                                                    data-testid="ShopifyPay-button"><span
                                                                        class="_11GJAaBiShTVGYuXppoYvE">
                                                                        ShopPay</span><span
                                                                        class="bp01pMHFBVS3SyhYtJKk"><svg
                                                                            preserveAspectRatio="xMidYMid"
                                                                            class="h7yAG5cgdBp_GhZjXmVIA"
                                                                            style="height: 24px; width: 82px;">
                                                                            <use
                                                                                xlink:href="#shopify-svg__payments-shopify-pay-light">
                                                                            </use>
                                                                        </svg></span></div>
                                                            </div>
                                                            <div class="_3TUeZPsTWjDxakSmeDcA4D"
                                                                data-testid="grid-cell">
                                                                <div role="button" tabindex="0"
                                                                    class="_1LP9NPTft85QosIXd3_zOV _3G6VJhJYno-AX3-X38f1TA _2zarRkvJ2j83NID3Q3t0Ix _1GxIZiuIYnVTrkxMSSrber"
                                                                    data-testid="GooglePay-button"><span
                                                                        class="_11GJAaBiShTVGYuXppoYvE">
                                                                        GooglePay</span><span
                                                                        class="bp01pMHFBVS3SyhYtJKk"><svg
                                                                            preserveAspectRatio="xMidYMid"
                                                                            class="h7yAG5cgdBp_GhZjXmVIA"
                                                                            style="height: 20px; width: 45.2632px;">
                                                                            <use
                                                                                xlink:href="#shopify-svg__payments-google-pay-light">
                                                                            </use>
                                                                        </svg></span></div>
                                                            </div>
                                                            <div class="_3TUeZPsTWjDxakSmeDcA4D"
                                                                data-testid="grid-cell"><iframe
                                                                    class="_1qHzu06EhANVVG3mlfU6Ho paypalLight _1n3zwJXRK30xbubjNiZsKV"
                                                                    title="Checkout with PayPal"
                                                                    __idm_frm__="874"></iframe></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
