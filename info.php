                ...
                <header class="main__header" role="banner">
                    ...
                    <nav aria-label="Breadcrumb">
                        <ul class="breadcrumb " role="list">
                            ...
                            <li class="breadcrumb__item " aria-current="step">
                ...
                <main class="main__content" role="main">
                    ...
                    <div class="step" data-step="contact_information" data-last-step="false">
                        <form class="edit_checkout">
                                        ...
                                        <div class="fieldset">
                                            <div data-shopify-pay-email-flow="true" class="field field--required">
                                                ...
                                                <div class="field__input-wrapper">
                                                    <input placeholder="Email" class="field__input" size="30"
                                                        type="email" value="nujaj@mailinator.com" name="checkout[email]"
                                                        id="checkout_email" />
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="checkbox-wrapper">
                                                    <div class="checkbox__input">
                                                        <input name="checkout[buyer_accepts_marketing]" type="hidden"
                                                            value="0" /><input class="input-checkbox" type="checkbox"
                                    ...
                                    <div class="section__content">
                                        <div class="fieldset">
                                            <div class="address-fields" data-address-fields>
                                                <input class="visually-hidden" size="30" type="text"
                                                ...
                                                <div class="field--half field field--required"
                                                    ...
                                                    <div class="field__input-wrapper">
                                                        <input placeholder="First name" class="field__input" size="30"
                                                            type="text" value="Judah" name=""
                                                ...
                                                <div class="field--half field field--required"
                                                    ...
                                                    <div class="field__input-wrapper">
                                                        <input placeholder="Last name" class="field__input" size="30"
                                                            type="text" value="Snider" name=""
                                                ...
                                                <div data-address-field="company"
                                                    ...
                                                    <div class="field__input-wrapper">
                                                        <input placeholder="Company (optional)"
                                                            autocomplete="shipping organization" class="field__input"
                                                            size="30" type="text" value="Schmidt and Mcneil Associates"
                                                            name="" id="checkout_shipping_address_company" />
                                                    </div>
                                                </div>
                                                <div data-address-field="address1"
                                                    ...
                                                    <div class="field__input-wrapper">
                                                        <input placeholder="Address" class="field__input" size="30"
                                                            type="text" value="277 North White Old Lane" name=""
                                                ...
                                                <div data-address-field="address2"
                                                    ...
                                                    <div class="field__input-wrapper">
                                                        <input placeholder="Apartment, suite, etc. (optional)"
                                                            ...
                                                            type="text" value="Et occaecat ut magna"
                                                            name="checkout[shipping_address][address2]"
                                                ...
                                                <div class="field--third field field--required"
                                                    ...
                                                    data-autocomplete-field-container="true">
                                                    <label class="field__label"
                                                        for="checkout_shipping_address_province">Region</label>
                                                    <div class="field__input-wrapper field__input-wrapper--select">
                                                        ...
                                                        <div class="field__icon">
                                                            <div data-tooltip="true" id="phone_tooltip"
                                                                class="tooltip-container"><button type="button"
                                                                    ...
                                                                    </svg></button><span class="tooltip" role="tooltip"
                                                                    id="tooltip-for-phone">In case we need to contact
                                                                    you about your order</span></div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="step__footer" data-step-footer>
                                ...
                                <a class="step__footer__previous-link" href="cart.php"><svg focusable="false"
                                        aria-hidden="true"
                    ...
                    <div class="hidden">
                        ...
                        <span class="visually-hidden" id="checkout-context-step-one">
                            Customer information - the MobileCover - Checkout
                        </span>
                    </div>
                </main>
                <!-- Footer Begin -->
